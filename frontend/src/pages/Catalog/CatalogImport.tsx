...
import { catalogService, ImportResult } from '../../services/catalogService'
...
const CatalogImport: React.FC = () => {
  ...
  const handleImport = async () => {
    ...
    setImporting(true)
    try {
      const result = await catalogService.importarExcel(selectedFile)
  ...
  const downloadTemplate = () => {
    ...
    const csvContent = `CATALOGO,Denominación,Grupo,Clase,Resolución,Estado
04.22.01.001,COMPUTADORA PERSONAL,04-AGRÍCOLA Y PESQUERO,22-EQUIPO,R.D. N° 001-2023,ACTIVO
04.22.01.002,LAPTOP,04-AGRÍCOLA Y PESQUERO,22-EQUIPO,R.D. N° 001-2023,ACTIVO`
        ...
        return (
          <Box>
                ...
                <List>
                  ...
                  <ListItem>
                    ...
                    <ListItemText
                      ...
                      secondary="CATALOGO, Denominación, Grupo, Clase, Resolución, Estado"
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
                    ...
                    <ListItemText
                      ...
                      secondary="Los códigos de catálogo y denominaciones deben ser únicos"
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemIcon>
            ...
            >
              ...
              <Typography variant="h6" gutterBottom>
                Seleccionar Archivo de Catálogo
              </Typography>
